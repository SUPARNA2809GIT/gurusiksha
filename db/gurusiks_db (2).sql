...
CREATE TABLE `tb_assesments_opt` (
...
CREATE TABLE `tb_current_course` (
...
CREATE TABLE `tb_mentors_subject` (
  `men_sub_id` int(11) NOT NULL,
  `mentor_id` int(11) NOT NULL,
  `subject_id` int(11) NOT NULL,
  `created_time` time NOT NULL,
  `created_date` date NOT NULL
...
CREATE TABLE `tb_mentor_tech_time` (
  `tech_time_id` int(11) NOT NULL,
  `user_id` int(11) NOT NULL,
  `subject_id` int(11) NOT NULL,
...
CREATE TABLE `tb_self_assesment` (
  `assmnt_id` int(11) NOT NULL,
  `class_id` int(11) NOT NULL,
  `subject_id` int(11) NOT NULL,
  `chapter_id` int(11) NOT NULL,
...
INSERT INTO `tb_self_assesment` (`assmnt_id`, `class_id`, `subject_id`, `chapter_id`, `created_date`, `created_time`) VALUES
(5, 3, 3, 1, '2018-12-05', '17:39:08');
...
CREATE TABLE `tb_self_assesment_q` (
  `assmnt_q_id` int(11) NOT NULL,
  `assmnt_id` int(11) NOT NULL,
...
INSERT INTO `tb_sms` (`sms_id`, `subject_id`, `sms_title`, `sms_description`, `created_date`, `created_time`, `mobile_no`, `class`) VALUES
(8, 3, 'Test', 'test', '2018-10-31', '07:56:38', '8961028221', 'ii');
...
CREATE TABLE `tb_students_subject` (
...
CREATE TABLE `tb_uploaded_assignment` (
...
INSERT INTO `td_chat` (`chat_id`, `from_id`, `user_type`, `to_id`, `msg`, `is_read`, `chat_date`, `chat_time`) VALUES
(1, 1, 'S', 0, 'Hello There Saikat Here', 1, '2018-12-04', '06:08:38 pm'),
(2, 1, 'S', 0, 'Iron Man VS Captain America ', 1, '2018-12-04', '06:09:01 pm'),
(3, 0, 'A', 1, 'Kiska hai ye tumko intezer main hu na', 1, '2018-12-04', '06:11:01 pm'),
(4, 1, 'S', 0, 'Thank you', 1, '2018-12-04', '06:55:46 pm'),
(5, 2, 'M', 0, 'Hello', 1, '2018-12-06', '01:55:21 pm'),
(6, 2, 'M', 0, 'You there', 1, '2018-12-06', '01:55:44 pm');
...
--
-- Indexes for table `tb_assesments_opt`
--
ALTER TABLE `tb_assesments_opt`
  ADD PRIMARY KEY (`opt_id`);

--
-- Indexes for table `tb_assignments`
--
...
--
-- Indexes for table `tb_current_course`
--
ALTER TABLE `tb_current_course`
  ADD PRIMARY KEY (`course_id`);

--
-- Indexes for table `tb_doc_charge`
--
ALTER TABLE `tb_doc_charge`
...
--
-- Indexes for table `tb_mentors`
--
ALTER TABLE `tb_mentors`
  ADD PRIMARY KEY (`mentor_id`);

--
-- Indexes for table `tb_mentors_subject`
--
ALTER TABLE `tb_mentors_subject`
  ADD PRIMARY KEY (`men_sub_id`);

--
-- Indexes for table `tb_mentor_tech_time`
--
ALTER TABLE `tb_mentor_tech_time`
  ADD PRIMARY KEY (`tech_time_id`);
...
--
-- Indexes for table `tb_post_comments`
--
ALTER TABLE `tb_post_comments`
  ADD PRIMARY KEY (`comment_id`);

--
-- Indexes for table `tb_post_report`
--
ALTER TABLE `tb_post_report`
  ADD PRIMARY KEY (`report_id`);

--
-- Indexes for table `tb_post_save`
--
ALTER TABLE `tb_post_save`
  ADD PRIMARY KEY (`save_id`);

--
-- Indexes for table `tb_post_view`
--
ALTER TABLE `tb_post_view`
  ADD PRIMARY KEY (`postv_id`);

--
-- Indexes for table `tb_self_assesment`
--
ALTER TABLE `tb_self_assesment`
  ADD PRIMARY KEY (`assmnt_id`);

--
-- Indexes for table `tb_self_assesment_q`
--
ALTER TABLE `tb_self_assesment_q`
  ADD PRIMARY KEY (`assmnt_q_id`);
...
--
-- Indexes for table `tb_students_subject`
--
ALTER TABLE `tb_students_subject`
  ADD PRIMARY KEY (`stu_sub_id`);

--
-- Indexes for table `tb_studymaterial`
--
ALTER TABLE `tb_studymaterial`
...
--
-- Indexes for table `tb_teaching_days`
--
ALTER TABLE `tb_teaching_days`
  ADD PRIMARY KEY (`day_id`);

--
-- Indexes for table `tb_teaching_time`
--
ALTER TABLE `tb_teaching_time`
...
--
-- Indexes for table `tb_uploaded_assignment`
--
ALTER TABLE `tb_uploaded_assignment`
...
--
-- Indexes for table `td_special_query`
--
ALTER TABLE `td_special_query`
  ADD PRIMARY KEY (`qid`);
...
--
-- AUTO_INCREMENT for table `tb_assesments_opt`
--
ALTER TABLE `tb_assesments_opt`
  MODIFY `opt_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=71;

--
-- AUTO_INCREMENT for table `tb_assignments`
--
ALTER TABLE `tb_assignments`
...
--
-- AUTO_INCREMENT for table `tb_current_course`
--
ALTER TABLE `tb_current_course`
  MODIFY `course_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=62;

--
-- AUTO_INCREMENT for table `tb_doc_charge`
--
ALTER TABLE `tb_doc_charge`
...
--
-- AUTO_INCREMENT for table `tb_guardian`
--
ALTER TABLE `tb_guardian`
...
--
-- AUTO_INCREMENT for table `tb_mentors`
--
ALTER TABLE `tb_mentors`
  MODIFY `mentor_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `tb_mentors_subject`
--
ALTER TABLE `tb_mentors_subject`
  MODIFY `men_sub_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;

--
-- AUTO_INCREMENT for table `tb_mentor_tech_time`
--
ALTER TABLE `tb_mentor_tech_time`
  MODIFY `tech_time_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
-- AUTO_INCREMENT for table `tb_post_comments`
--
ALTER TABLE `tb_post_comments`
  MODIFY `comment_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `tb_post_report`
--
ALTER TABLE `tb_post_report`
  MODIFY `report_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `tb_post_save`
--
ALTER TABLE `tb_post_save`
  MODIFY `save_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;

--
-- AUTO_INCREMENT for table `tb_post_view`
--
ALTER TABLE `tb_post_view`
  MODIFY `postv_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `tb_self_assesment`
--
ALTER TABLE `tb_self_assesment`
  MODIFY `assmnt_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT for table `tb_self_assesment_q`
--
ALTER TABLE `tb_self_assesment_q`
  MODIFY `assmnt_q_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;
...
--
-- AUTO_INCREMENT for table `tb_students_subject`
--
ALTER TABLE `tb_students_subject`
  MODIFY `stu_sub_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT for table `tb_studymaterial`
--
ALTER TABLE `tb_studymaterial`
  MODIFY `studymaterial_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
...
--
-- AUTO_INCREMENT for table `tb_teaching_days`
--
ALTER TABLE `tb_teaching_days`
  MODIFY `day_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `tb_teaching_time`
--
ALTER TABLE `tb_teaching_time`
...
--
-- AUTO_INCREMENT for table `tb_uploaded_assignment`
--
ALTER TABLE `tb_uploaded_assignment`
  MODIFY `assgn_id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `td_special_query`
--
ALTER TABLE `td_special_query`
