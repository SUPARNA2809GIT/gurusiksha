...
<section id="sliderBar">
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-md-6">
        <div class="well">
          <form action="<?php echo base_url() ?>admin/gallery/update" method="post" enctype="multipart/form-data">
          <?php echo $this->session->flashdata('success') ?>
            <div class="form-group">
              <label>Image Title <span style="color:#FF0000; font-weight:normal;">(Maximum 30 Characters)</span></label>
              <input type="hidden" name="image_id" value="<?php echo $result[0]->image_id; ?>"  /> 
              <input type="text" class="form-control" id="img-title" name="img-title" maxlength="30" value="<?php echo $result[0]->image_title; ?>" required>
            </div>
            <img src="<?php echo base_url() ?>uploads/gallery/<?php echo $result[0]->image_path ?>" height="80" width="120" style="margin-bottom:10px"  />
            
            <div class="form-group">
              
              <label>Choose Image File <span style="color:#FF0000; font-weight:normal;">(Size- width: 960px and Height: 640px)</span></label>
              <input type="file" class="form-control" id="gallery-img" name="gallery-img">
            </div>
