            ...
            <div id="frame">
              ...
              <div class="content" id="contentMentor">
                ...
                if(!empty($AllMentors))
                {
                    ...
                    $chatDeatils = $this->db->query("SELECT * FROM td_chat WHERE (from_id=".$id." OR to_id=".$id.") AND (user_type='M' OR to_user_type='M') ORDER BY chat_id ASC")->result();
                }
             ...
             ?>
              ...
              <?php } ?>
                ...
                <div class="messages">
                  ...
                  if(!empty($AllMentors) && !empty($chatDeatils))
                  {
                    foreach ($chatDeatils as $chmt) 
                    {
              ...
              <div id="frame">
                ...
                <div class="content" id="contentGuardian">
                  ...
                  if(!empty($AllGuardians))
                  {
                      ...
                      $chatDeatils = $this->db->query("SELECT * FROM td_chat WHERE (from_id=".$id." OR to_id=".$id.") AND (user_type='G' OR to_user_type='G') ORDER BY chat_id ASC")->result();
                  }
                ...
                <?php } ?>
                  <div class="messages">
                    <ul>
                      <?php
                          if(!empty($AllGuardians) &&  !empty($chatDeatils))
                          {
                            foreach ($chatDeatils as $chgt) 
                            {
