...
class Add extends CI_Controller {
   ...
   public function __construct() {
	...
	public function language()
	{
		...
		if($data['search'] != ''){
			$where .= "language_name LIKE '%".trim($data['search'])."%' OR ";
		}
		...
		$this->form_validation->set_rules($this->validation_rules_lang['Add']);
	...
	public function subject()
	{
		...
		$data['search']		  = $this->input->get('search');
		if($data['search'] != ''){
			$where .= "subject LIKE '%".trim($data['search'])."%' OR ";
		}
		...
		$nSer="SELECT * FROM  tb_subject ".$where." ORDER BY subject_id DESC";
		$sql=$nSer." LIMIT ".$limit." OFFSET  ".$offset." ";
		$language=$this->db->query($sql);		
		$total_rows=count($this->db->query($nSer)->result());	
		$data['languages'] = $language->result();
		...
		$this->form_validation->set_rules($this->validation_rules_subject['Add']);
	...
	public function class_entry()
	{
		...
		$data['search']		  = $this->input->get('search');
		if($data['search'] != ''){
			$where .= "class LIKE '%".trim($data['search'])."%' OR ";
		}
		...
		$nSer="SELECT * FROM  tb_class ".$where." ORDER BY class_id ASC";
		$sql=$nSer." LIMIT ".$limit." OFFSET  ".$offset." ";
		$language=$this->db->query($sql);		
		$total_rows=count($this->db->query($nSer)->result());	
		$data['languages'] = $language->result();
		...
		$this->form_validation->set_rules($this->validation_rules_class['Add']);
	...
	public function time()
	{
		...
		$data['search']		  = $this->input->get('search');
		if($data['search'] != ''){
			$where .= "time LIKE '%".trim($data['search'])."%' OR ";
		}
		...
		$nSer="SELECT * FROM  tb_teaching_time ".$where." ORDER BY time_id DESC";
		$sql=$nSer." LIMIT ".$limit." OFFSET  ".$offset." ";
		$language=$this->db->query($sql);		
		$total_rows=count($this->db->query($nSer)->result());	
		$data['languages'] = $language->result();
		...
		$this->form_validation->set_rules($this->validation_rules_time['Add']);
	...
	public function days()
	{
		...
		$nSer="SELECT * FROM  tb_teaching_days ".$where." ORDER BY day_id DESC";
		$sql=$nSer." LIMIT ".$limit." OFFSET  ".$offset." ";
		$language=$this->db->query($sql);		
		$total_rows=count($this->db->query($nSer)->result());	
		$data['languages'] = $language->result();
		...
		$this->form_validation->set_rules($this->validation_rules_day['Add']);
	...
	public function student()
	{
		...
		$nSer="SELECT * FROM  tb_students ".$where." ORDER BY student_id DESC";
		$sql=$nSer." LIMIT ".$limit." OFFSET  ".$offset." ";
		$language=$this->db->query($sql);		
		$total_rows=count($this->db->query($nSer)->result());	
		$data['languages'] = $language->result();
		...
		$this->form_validation->set_rules($this->validation_rules_student['Add']);
	...
	public function mentor()
	{
		...
		$nSer="SELECT * FROM  tb_mentors ".$where." ORDER BY mentor_id DESC";
		$sql=$nSer." LIMIT ".$limit." OFFSET  ".$offset." ";
		$language=$this->db->query($sql);		
		$total_rows=count($this->db->query($nSer)->result());	
		$data['languages'] = $language->result();
		$data['total_rows']=$total_rows;
		$data['limit']=$limit;
		$config['base_url'] = base_url()."add/mentor";
		$config['total_rows'] = $total_rows;
		$config['per_page'] = $limit;
		$config['page_query_string'] = TRUE;
	    $config['full_tag_open'] = "<ul class='pagination pagination-sm text-center'>";
	...
	public function guardian()
	{
		...
		$nSer="SELECT * FROM  tb_guardian ".$where." ORDER BY guardian_id DESC";
		$sql=$nSer." LIMIT ".$limit." OFFSET  ".$offset." ";
		$language=$this->db->query($sql);		
		$total_rows=count($this->db->query($nSer)->result());	
		$data['languages'] = $language->result();
