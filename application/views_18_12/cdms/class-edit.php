...
<section id="sliderBar">
  <div class="container">
    <p class="heading3" style="color:#003399;">Update Class</p>
    <div class="row">
    
      <form method="post" action="<?php echo base_url() ?>edit/class_entry/<?php echo $v->class_id; ?>" >
       <?php echo $this->session->flashdata('success'); ?>
        <div class="form-row">
          <div class="form-group col-md-12">
            <label>Class Name</label>
            <input type="text" class="form-control" id="cust-name" name="class-name" value="<?php echo $v->class; ?>">
            <?php echo form_error('class-name','<span class="text-danger">','</span>'); ?>
          </div>
          <div class="form-group col-md-12">
            <button type="submit" id="submit" class="btn btn-primary">Update</button>
            <a href="<?php echo base_url() ?>add/class_entry" class="btn btn-primary">Back To List</a>
          </div>
        </div>
      </form>
    </div>
...
<!-- <section id="sliderBar2">
  <div class="container">
    <p class="heading3" style="color:#003399;">Class Details <span class="pull-right">
          ...
          else
          {
			...
			?>
              <tr>
                ...
                <td><a href="<?php echo base_url() ?>home/edit/<?php echo $v->class_id; ?>" class="btn btn-success btn-xs">Edit</a>
                  <a onClick="return confirm('Would You Like To Delete This?');" href="<?php echo base_url() ?>home/delete/<?php echo $v->class_id; ?>" class="btn btn-danger btn-xs">Delete</a></td>
              </tr>
              <?php  $i++; } 
