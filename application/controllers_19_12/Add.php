   ...
   public function __construct() {
	...
	public function chapter()
	{
		...
		if($this->form_validation->run() == true )
		{
            ...
            $count = $this->db->query("SELECT * FROM tb_chapter WHERE subject_id='".$subject_id."' AND lower(chapter)='".strtolower($chapter)."'")->num_rows();
	...
	public function sendSms()
	{
		...
		{			
		    ...
		    for($i=0; $i < count($students) ; $i++){
				...
				$post_fields="username=SUSOMA&password=h7gsDPY0&type=TEXT&sender=SUSOMA&mobile=".$stuRow->mobile."&message=".$sms_desc;
            ...
            for($j=0; $j < count($mentors) ; $j++){
                ...
                $base_url="http://5.189.187.82/sendsms/bulksms.php?";
                $post_fields="username=SUSOMA&password=h7gsDPY0&type=TEXT&sender=SUSOMA&mobile=".$mentRow->mentor_mobile."&message=".$sms_desc;
    ...
    public function notification()
    {
        ...
        if($this->input->post('title')!='' && $this->input->post('description')!='')
        {
            ...
            $url = 'https://fcm.googleapis.com/fcm/send';
                ...
                $query= $this->db->query("SELECT * FROM td_device_log")->result();
            ...
            {       
                foreach($query as $list){
                    ...
                    $fields1 = array(
                        ...
                        $sender = $this->base_model->form_post('tbl_push',$fields1);
                ...
                $headers = array (
                        'Authorization: key=' . "AIzaSyDEpmD9Y2aLBbmrNBHbHGUCj95-oVz1jVc",
        ...
        $this->load->view('cdms/notification');
    }
